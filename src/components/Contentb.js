...
function Contentb() {
  return (
    <div className="mx-5 md:mx-14 mt-5  pt-2 bg-blue-100 rounded-2xl border-2 border-blue-800">
      <div className='mx-2 md:mx-5 my-2 '>
        ...
        <p className="font-roboto text-left leading-5 py-3 ">
          ...
          editing. I love designing and creating 3D models, so I have created these, hope you enjoy!
        </p>
        <div className="grid gap-y-6 md:grid-rows-1 md:overflow-x-auto md:grid-cols-3 md:gap-6">
          <Imagecardb
            ...
            content={"Beautiful Geometry Nodes Abstract Model & Environment in Blender"}
